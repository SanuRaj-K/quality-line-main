...
export const Branches = ({ title, icon, id, phone, fax, email }: any) => {
  return (
    <div>
      <div className=" w-[400px]  shadow-md hover:shadow-lg bg-white group transition-all duration-300 border border-gray-100 relative flex py-[25px] px-[20px]">
      ...
      rounded-md flex items-center group-hover:text-white justify-center h-fit bg-red-300"
        >
          <Magnet>
            <Image
              quality={100}
